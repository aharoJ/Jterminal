...
base_dict = file_to_dict("dev_scripts/data_comparison/base_file/base.txt")

directory = "dev_scripts/data_comparison/m_files"
...
df.to_excel("EXEL_OUTPUT.xlsx", index=False)
